...
public class ExcitedWatchPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_excited_watch_page);
    ...
    public void transitionToExcitedMainPage()
    {
        buttonBackMenu.setOnClickListener(v -> {
            Intent changeToVideoPage = new Intent(ExcitedWatchPage.this, ExcitedMainPage.class);
